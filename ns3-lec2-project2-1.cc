...
main (int argc, char *argv[])
{
  ...
  csmaNodes.Add (p2pNodes.Get (1));  //n1 node
...
//创建wifista无线终端，AP接入点
  ...
  NodeContainer wifiApNode = p2pNodes.Get (0); //n0 node
...
//配置AP移动方式，ConstantPositionMobilityModel，固定位置模型
 ...
 //wifi信道
  ...
  ApplicationContainer clientApps4 = 
    echoClient.Install (wifiStaNodes.Get (nWifi - 4));
